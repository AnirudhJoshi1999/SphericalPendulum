...
dbeta0   = 3;                        % d/dt(phi)             [rad/s]

x0 = [theta0 beat0 dtheta0 dbeta0]';

% Parameters
tf      = 30;                       % Final time            [s]
fR      = 30;                       % Frame rate            [fps]
dt      = 1/fR;                     % Time resolution       [s]
time    = linspace(0,tf,tf*fR);     % Time                  [s] linspace creates linearly spaced vectors so here between 0 and 30 there are 900 equal intervals
